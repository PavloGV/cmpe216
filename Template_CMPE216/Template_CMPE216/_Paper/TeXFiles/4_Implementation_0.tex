...
\begin{figure}[H]
\begin{center}
\subfigure[Compressed jumping mechanism]{\includegraphics[width=0.4\linewidth]{./_Figures/AccelerationMechanism.png} }
\subfigure[Extended jumping mechanism]{\includegraphics[width=0.4\linewidth]{./_Figures/AccelerationMechanism2.png} } 
...
\begin{figure}[H]
\begin{center}
\subfigure[Folded wings]{\includegraphics[height=0.3\linewidth]{./_Figures/wings2.png} }
\subfigure[Extended wings]{\includegraphics[width=0.4\linewidth]{./_Figures/wings.png} } 
\caption{Example of a chart}
\label{fig:wings}
\end{center}
\end{figure} 
